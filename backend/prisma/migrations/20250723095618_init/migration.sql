...
-- AddForeignKey
ALTER TABLE "manufacturing_order_items" ADD CONSTRAINT "manufacturing_order_items_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "manufacturing_orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
