...
const ReportsPage: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['inventoryReports', filters, activeMainTab],
    queryFn: async () => {
      const params = new URLSearchParams();
      params.append('period', filters.period);
    ...
    enabled: activeMainTab === 'inventory'
  });
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-start justify-between sm:flex-row sm:items-center">
        ...
        <div className="flex gap-2 mt-4 sm:mt-0">
          ...
          <button
            onClick={activeMainTab === 'sales' ? exportToPDF : exportInventoryToPDF}
            className="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50"
          >
          ...
          <button
            onClick={activeMainTab === 'sales' ? exportToExcel : exportInventoryToExcel}
